...
Key.startCapture = function (target) {
  ...
  _targetObject.addEventListener('keydown', Key.keyDown);
  _targetObject.addEventListener('keyup', Key.keyUp);
  _targetObject.addEventListener('blur',Key.resetKeys);
  _targetObject.addEventListener('focus', Key.restartKeys);
...
Key.endCapture = function () {
  if (_captureStarted) {
    _targetObject.removeEventListener('keydown', Key.keyDown);
    _targetObject.removeEventListener('keyup', Key.keyUp);
    _targetObject.removeEventListener('blur',Key.resetKeys);
    _targetObject.removeEventListener('focus', Key.restartKeys);
    _targetObject = null;
